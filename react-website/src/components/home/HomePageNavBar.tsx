...
const HomePageNavBar = () => {
    ...
    function getTabClassName(tab: number) {
        return isTabActive(tab) ?
            'relative h-10 top-2 bg-primary-light-s1l3 dark:bg-primary-dark-s1l3 font-bold underline pointer-events-none' : // Active Tab
            'relative h-12 top-0 bg-primary-light-s1l5 dark:bg-primary-dark-s1l5 animate-homePageNavBar_OnHoverExit hover:h-10 hover:top-2 hover:bg-primary-light-s1l6 dark:hover:bg-primary-dark-s1l6 hover:animate-homePageNavBar_OnHoverEnter hover:underline'; // Inactive Tab
    }
